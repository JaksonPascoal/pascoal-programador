...
class ArrowExpr(EagerExpr["ArrowDataFrame", ArrowSeries]):
    ...
    def from_column_names(
        ...
        *,
        ...
        def func(df: ArrowDataFrame) -> list[ArrowSeries]:
            try:
                return [
                    ArrowSeries(df.native[column_name], name=column_name, version=df._version)
    ...
    def from_column_indices(cls, *column_indices: int, context: _LimitedContext) -> Self:
        def func(df: ArrowDataFrame) -> list[ArrowSeries]:
            ...
            cols = df.columns
            return [
                ArrowSeries.from_native(tbl[i], name=cols[i], context=df) for i in column_indices
            ]
    ...
    def over(self, partition_by: Sequence[str], order_by: Sequence[str]) -> Self:
        if partition_by and self._metadata is not None and not self._metadata.is_scalar_like:
