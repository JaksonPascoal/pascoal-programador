...
class ArrowNamespace(
    ...
    def min_horizontal(self, *exprs: ArrowExpr) -> ArrowExpr:
        def func(df: ArrowDataFrame) -> list[ArrowSeries]:
            ...
            return [ArrowSeries(native_series, name=init_series.name, version=self._version)]
    ...
    def concat_str(self, *exprs: ArrowExpr, separator: str, ignore_nulls: bool) -> ArrowExpr:
        def func(df: ArrowDataFrame) -> list[ArrowSeries]:
            align = self._series._align_full_broadcast
            compliant_series_list = align(*(chain.from_iterable(expr(df) for expr in exprs)))
...
class ArrowThen(CompliantThen[ArrowDataFrame, ArrowSeries, ArrowExpr, ArrowWhen], ArrowExpr):
    _depth: int = 0
