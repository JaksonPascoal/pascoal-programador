...
class ArrowSeries(EagerSeries["ChunkedArrayAny"]):
    ...
    def __init__(self, native_series: ChunkedArrayAny, *, name: str, version: Version) -> None:
        self._name = name
    ...
    def value_counts(
        ...
        return ArrowDataFrame(val_count, version=self._version, validate_column_names=True)
    ...
    def clip(
        ...
        _, lower = extract_native(self, lower_bound) if lower_bound is not None else (None, None)
        _, upper = extract_native(self, upper_bound) if upper_bound is not None else (None, None)
    ...
    def hist_from_bins(self, bins: list[float], *, include_breakpoint: bool) -> ArrowDataFrame:
        return (
    ...
    def hist_from_bin_count(self, bin_count: int, *, include_breakpoint: bool) -> ArrowDataFrame:
        return (
            _ArrowHist.from_series(self, include_breakpoint=include_breakpoint)
