...
class EagerSeriesHist(Protocol[NativeSeriesT, _CountsT_co]):
    ...
    @classmethod
    def from_series(cls, series: EagerSeries[NativeSeriesT], *, include_breakpoint: bool) -> Self:
        obj = cls.__new__(cls)
        obj._series = series
    ...
    def series_empty(self, arg: int | list[float], /) -> HistData[NativeSeriesT, _CountsT_co]: ...
