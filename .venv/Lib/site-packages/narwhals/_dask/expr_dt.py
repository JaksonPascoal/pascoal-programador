...
class DaskExprDateTimeNamespace(LazyExprNamespace["DaskExpr"], DateTimeNamespace["DaskExpr"]):
    ...
    def microsecond(self) -> DaskExpr:
        return self.compliant._with_callable(lambda expr: expr.dt.microsecond, "microsecond")
    ...
    def ordinal_day(self) -> DaskExpr:
        return self.compliant._with_callable(lambda expr: expr.dt.dayofyear, "ordinal_day")
    ...
    def convert_time_zone(self, time_zone: str) -> DaskExpr:
        def func(s: dx.Series, time_zone: str) -> dx.Series:
            dtype = native_to_narwhals_dtype(s.dtype, self.compliant._version, Implementation.DASK)
