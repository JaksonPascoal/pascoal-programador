...
class DuckDBExprDateTimeNamespace(SQLExprDateTimeNamesSpace["DuckDBExpr"]):
    ...
    def to_string(self, format: str) -> DuckDBExpr:
        return self.compliant._with_elementwise(lambda expr: F("strftime", expr, lit(format)))
    ...
    def total_minutes(self) -> DuckDBExpr:
        return self.compliant._with_elementwise(lambda expr: F("datepart", lit("minute"), expr))
