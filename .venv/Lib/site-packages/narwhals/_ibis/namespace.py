...
class IbisNamespace(SQLNamespace[IbisLazyFrame, IbisExpr, "ir.Table", "ir.Value"]):
    ...
    def concat(self, items: Iterable[IbisLazyFrame], *, how: ConcatMethod) -> IbisLazyFrame:
        if how == "diagonal":
    ...
    def concat_str(self, *exprs: IbisExpr, separator: str, ignore_nulls: bool) -> IbisExpr:
