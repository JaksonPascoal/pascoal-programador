...
def set_index(obj: NativeNDFrameT, index: Any, *, implementation: Implementation) -> NativeNDFrameT:
...
def native_to_narwhals_dtype(
    ...
    *,
    ...
    if str_dtype == "category" and implementation.is_cudf():
        ...
        return native_categorical_to_narwhals_dtype(native_dtype, version, Implementation.CUDF)
    if str_dtype != "object":
...
def narwhals_to_native_dtype(  # noqa: C901, PLR0912
    ...
    if isinstance_or_issubclass(dtype, dtypes.Datetime):
        ...
        if is_pandas_or_modin(implementation) and PANDAS_VERSION < (2,):  # pragma: no cover
            dt_time_unit = "ns"
        else:
...
def select_columns_by_name(
    ...
    if (df.columns.dtype.kind == "b") or (
        implementation is Implementation.PANDAS and implementation._backend_version() < (1, 5)
    ):
...
def is_non_nullable_boolean(s: PandasLikeSeries) -> bool:
    ...
    return (
        s._implementation in {Implementation.PANDAS, Implementation.MODIN, Implementation.DASK}
