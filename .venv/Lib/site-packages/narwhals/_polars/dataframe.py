...
class PolarsBaseFrame(Generic[NativePolarsFrame]):
    ...
    def top_k(self, k: int, *, by: str | Iterable[str], reverse: bool | Sequence[bool]) -> Self:
    ...
    def collect_schema(self) -> dict[str, DType]:
        ...
        return {
            name: native_to_narwhals_dtype(dtype, self._version) for name, dtype in schema.items()
        }
