...
def native_to_narwhals_dtype(dtype: pl.DataType, version: Version) -> DType:  # noqa: C901, PLR0912
    ...
    if isinstance_or_issubclass(dtype, pl.Struct):
        fields = [dtypes.Field(name, native_to_narwhals_dtype(tp, version)) for name, tp in dtype]
