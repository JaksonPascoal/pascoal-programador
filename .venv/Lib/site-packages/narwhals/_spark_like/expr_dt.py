...
class SparkLikeExprDateTimeNamespace(SQLExprDateTimeNamesSpace["SparkLikeExpr"]):
    ...
    def replace_time_zone(self, time_zone: str | None) -> SparkLikeExpr:  # pragma: no cover
        if time_zone is None:
            return self.compliant._with_elementwise(lambda expr: expr.cast("timestamp_ntz"))
        return self._no_op_time_zone(time_zone)
    ...
    def _format_microseconds(self, expr: Column, format: str) -> tuple[str, tuple[Column, ...]]:
