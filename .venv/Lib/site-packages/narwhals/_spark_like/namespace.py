...
class SparkLikeNamespace(
    ...
    def _when(self, condition: Column, value: Column, otherwise: Column | None = None) -> Column:
        ...
        def func(df: SparkLikeLazyFrame) -> list[Column]:
            ...
            if not ignore_nulls:
                ...
                result = reduce(
                    ...
                    (df._F.format_string("%s%s", s, v) for s, v in zip_strict(separators, values)),
                    init_value,
                )
...
class SparkLikeThen(SQLThen[SparkLikeLazyFrame, "Column", SparkLikeExpr], SparkLikeExpr): ...
