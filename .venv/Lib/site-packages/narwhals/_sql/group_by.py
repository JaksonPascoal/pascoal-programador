...
class SQLGroupBy(
    ...
    def _evaluate_expr(self, expr: SQLExprT_contra, /) -> Iterator[NativeExprT_co]:
        ...
        if expr._is_multi_output_unnamed():
            ...
            for native_expr, name, alias in zip_strict(native_exprs, output_names, aliases):
    ...
    def _evaluate_exprs(self, exprs: Iterable[SQLExprT_contra], /) -> Iterator[NativeExprT_co]:
        for expr in exprs:
