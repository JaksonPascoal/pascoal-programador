...
def _is_iterable(arg: Any | Iterable[Any]) -> bool:
    ...
    if ((pd := get_pandas()) is not None and isinstance(arg, (pd.Series, pd.DataFrame))) or (
...
def isinstance_or_issubclass(
    obj_or_cls: object | type,
    cls_or_tuple: tuple[type[_T1], type[_T2], type[_T3], type[_T4], type[_T5], type[_T6]],
) -> TypeIs[_T1 | _T2 | _T3 | _T4 | _T5 | _T6 | type[_T1 | _T2 | _T3 | _T4 | _T5 | _T6]]: ...
...
def isinstance_or_issubclass(
    ...
    _T1 | _T2 | _T3 | _T4 | _T5 | _T6 | _T7 | type[_T1 | _T2 | _T3 | _T4 | _T5 | _T6 | _T7]
]: ...
...
def generate_unique_token(n_bytes: int, columns: Container[str]) -> str:  # pragma: no cover
    msg = (
...
def is_compliant_dataframe(
    obj: (
        CompliantDataFrame[CompliantSeriesT, CompliantExprT, NativeDataFrameT, ToNarwhalsT_co] | Any
    ),
) -> TypeIs[CompliantDataFrame[CompliantSeriesT, CompliantExprT, NativeDataFrameT, ToNarwhalsT_co]]:
