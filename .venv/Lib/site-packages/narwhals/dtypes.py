...
def _is_into_dtype(obj: Any) -> TypeIs[IntoDType]:
    return isinstance(obj, DType) or (
        isinstance(obj, type) and issubclass(obj, DType) and not issubclass(obj, NestedType)
    )
...
class Field:
    ...
    def __eq__(self, other: Field) -> bool:  # type: ignore[override]
        ...
        """
        return (
            isinstance(other, Field) and (self.name == other.name) and (self.dtype == other.dtype)
        )
