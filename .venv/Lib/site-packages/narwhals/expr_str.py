...
class ExprStringNamespace(Generic[ExprT]):
        ...
        return self._expr._with_elementwise(
            lambda plx: (
                apply_n_ary_operation(
                    plx,
                    lambda self, value: self.str.replace(pattern, value, literal=literal, n=n),
                    self._expr,
                    value,
                    str_as_lit=True,
                )
    ...
    def replace_all(self, pattern: str, value: str | ExprT, *, literal: bool = False) -> ExprT:
        ...
        return self._expr._with_elementwise(
            lambda plx: (
                apply_n_ary_operation(
                    plx,
                    lambda self, value: self.str.replace_all(pattern, value, literal=literal),
                    self._expr,
                    value,
                    str_as_lit=True,
                )
