...
def concat(items: Iterable[FrameT], *, how: ConcatMethod = "vertical") -> FrameT:
    ...
    return first_item._with_compliant(plx.concat([df._compliant_frame for df in items], how=how))
...
def _new_series_impl(
    ...
    *,
    ...
    if implementation is Implementation.UNKNOWN:  # pragma: no cover
        ...
        try:
            native_series: NativeSeries = _native_namespace.new_series(name, values, dtype)
    ...
    *,
    ...
    if implementation is Implementation.UNKNOWN:  # pragma: no cover
        ...
        try:
            ...
            native_frame: NativeDataFrame = _native_namespace.from_dict(data, schema=schema)
        except AttributeError as e:
    ...
    *,
    ...
    if implementation is Implementation.UNKNOWN:  # pragma: no cover
        ...
        try:
            ...
            native_frame: NativeDataFrame = _native_namespace.from_numpy(data, schema=schema)
        except AttributeError as e:
...
def read_csv(source: str, *, backend: IntoBackend[EagerAllowed], **kwargs: Any) -> DataFrame[Any]:
...
def scan_csv(source: str, *, backend: IntoBackend[Backend], **kwargs: Any) -> LazyFrame[Any]:
...
def scan_parquet(source: str, *, backend: IntoBackend[Backend], **kwargs: Any) -> LazyFrame[Any]:
...
def _expr_with_n_ary_op(
    ...
    *exprs: IntoExpr,
    ...
    if not exprs:
        ...
        raise ValueError(msg)
    return Expr(
        lambda plx: apply_n_ary_operation(plx, operation_factory(plx), *exprs, str_as_lit=False),
...
def sum_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    Examples:
        ...
        └────────────────────┘
    """
    return _expr_with_n_ary_op("sum_horizontal", lambda plx: plx.sum_horizontal, *flatten(exprs))
...
def min_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    Examples:
        ...
        └──────────────────┘
    """
    return _expr_with_n_ary_op("min_horizontal", lambda plx: plx.min_horizontal, *flatten(exprs))
...
def max_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    Examples:
        ...
        └──────────────────────┘
    """
    return _expr_with_n_ary_op("max_horizontal", lambda plx: plx.max_horizontal, *flatten(exprs))
...
def mean_horizontal(*exprs: IntoExpr | Iterable[IntoExpr]) -> Expr:
    ...
    Examples:
        ...
        └──────────────────┘
    """
    return _expr_with_n_ary_op("mean_horizontal", lambda plx: plx.mean_horizontal, *flatten(exprs))
