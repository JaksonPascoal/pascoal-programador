...
class Schema(OrderedDict[str, "DType"]):
    ...
    def from_arrow(cls, schema: IntoArrowSchema, /) -> Self:
        ...
        return cls(
            (field.name, native_to_narwhals_dtype(field.type, cls._version)) for field in schema
        )
    ...
    @classmethod
    def from_native(cls, schema: IntoArrowSchema | IntoPolarsSchema | IntoPandasSchema, /) -> Self:
    ...
    def from_polars(cls, schema: IntoPolarsSchema, /) -> Self:
        ...
        return cls(
            (name, native_to_narwhals_dtype(dtype, cls._version)) for name, dtype in schema.items()
        )
    ...
    @classmethod
    def _from_pandas_like(cls, schema: IntoPandasSchema, implementation: Implementation, /) -> Self:
