...
class Series(NwSeries[IntoSeriesT]):
    ...
    def value_counts(
        ...
        *,
        ...
        return _stableify(
            super().value_counts(sort=sort, parallel=parallel, name=name, normalize=normalize)
        )
    ...
    def hist(
        ...
        *,
        ...
        return _stableify(
            super().hist(bins=bins, bin_count=bin_count, include_breakpoint=include_breakpoint)
        )
...
def from_native(
    native_object: IntoDataFrameT | IntoLazyFrameT | IntoFrame | IntoSeriesT | IntoSeries | T,
    *,
    ...
    **kwds: Any,
    ...
    pass_through = validate_strict_and_pass_though(strict, pass_through, pass_through_default=False)
    if kwds:
...
def to_native(
    narwhals_object: DataFrame[IntoDataFrameT] | LazyFrame[IntoLazyFrameT] | Series[IntoSeriesT],
    *,
    strict: bool | None = None,
    pass_through: bool | None = None,
...
def narwhalify(
    ...
    *,
    ...
    recommend using `backend`, as that's available beyond just `narwhals.stable.v1`.
    """
    pass_through = validate_strict_and_pass_though(strict, pass_through, pass_through_default=True)
...
def all_horizontal(*exprs: IntoExpr | Iterable[IntoExpr], ignore_nulls: bool = False) -> Expr:
    return _stableify(nw.all_horizontal(*exprs, ignore_nulls=ignore_nulls))


def any_horizontal(*exprs: IntoExpr | Iterable[IntoExpr], ignore_nulls: bool = False) -> Expr:
