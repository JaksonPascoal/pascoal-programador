...
def from_native(  # noqa: D417
    native_object: IntoLazyFrameT | IntoDataFrameT | IntoSeriesT | IntoFrame | IntoSeries | T,
    *,
    pass_through: bool = False,
    ...
    *,
    ...
    if is_dask_dataframe(native_object):
        ...
        if eager_only or eager_or_interchange_only:
            ...
            return native_object
        if (
            Implementation.DASK._backend_version() <= (2024, 12, 1) and get_dask_expr() is None
        ):  # pragma: no cover
...
def _get_native_namespace_single_obj(
    ...
    return Version.MAIN.namespace.from_native_object(obj).implementation.to_native_namespace()
