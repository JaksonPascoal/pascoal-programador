...
from pyarrow.fs import LocalFileSystem, FileType, _resolve_filesystem_and_path, _ensure_filesystem
...
class ParquetFile:
    ...
    def _get_column_indices(self, column_names, use_pandas_metadata=False):
        ...
        if use_pandas_metadata:
            ...
            common_keyvalues = (
                self.common_metadata.metadata if self.common_metadata is not None else None
            )
    ...
    def read(self, columns=None, use_threads=True, use_pandas_metadata=False):
        ...
        if columns is not None and use_pandas_metadata:
            if metadata and b"pandas" in metadata:
                ...
                index_columns = [
                    col for col in _get_pandas_index_columns(metadata) if not isinstance(col, dict)
                ]
